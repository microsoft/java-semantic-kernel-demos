...
public class AzureCognitiveSearchMemoryStore implements MemoryStore {
    ...
    public Mono<Collection<Tuple2<MemoryRecord, Float>>> getNearestMatchesAsync(
        ...
        VectorSearchOptions searchVector =
                new VectorSearchOptions()
                        .setQueries(new VectorizedQuery(embedding.getVector()).setFields("Embedding"));

        SearchOptions searchOptions = new SearchOptions()
                .setQueryType(QueryType.SEMANTIC)
                .setSemanticSearchOptions(new SemanticSearchOptions().setSemanticConfigurationName("contents-search"));
        //.setVectorSearchOptions(searchVector);
    ...
    static List<SearchField> searchFields(String configName, int embeddingSize) {
        return Arrays.asList(
                ...
                new SearchField(
                        ...
                        .setVectorSearchProfileName(configName),
    ...
    private Mono<Response<SearchIndex>> createIndexAsync(
        ...
        VectorSearch vectorSearch =
                new VectorSearch()
                        .setProfiles(new VectorSearchProfile(
                                SEARCH_CONFIG_NAME,
                                "cosineSearch"))
                        .setAlgorithms(
                                new HnswAlgorithmConfiguration("cosineSearch")
                                        .setParameters(
                                                new HnswParameters()
                                                        .setMetric(
